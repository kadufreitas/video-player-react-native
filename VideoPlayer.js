...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    _onProgress(data = {}) {
        ...
        state.currentTimeInDeciSeconds =
            Math.floor(data.currentTime * 10) / 10.0
    ...
    */
    ...
    binarySearch = (subtitles, first, last, value) => {
        ...
        if (
            value >
                this.parseTimeStringToDeciSecond(subtitles[mid].startTime) &&
            ...
            <Animated.View
                style={[
                    styles.controls.bottom,
                    {
                        ...
                        marginBottom: this.animations.bottomControl
                            .marginBottom,
                    },
                ]}
            >
